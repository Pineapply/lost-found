...
Missing.create(name: "Floral fabric wallet", description: "Floral fabric wallet left on tram (or tram stop?).", type:"Missing",thumbnail: "https://raw.githubusercontent.com/Boo-Hiss/lost-found/master/app/assets/images/floral-wallet-red.jpeg")
